...
import {
  LayoutDashboard, Package, BarChart3, Wallet, PlusCircle, Settings,
  Bell, Zap, CheckCheck, ShoppingBag, Link2
} from 'lucide-react'
...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: '/seller/products', icon: Package, label: 'Produk Saya' },
      { href: '/seller/analytics', icon: BarChart3, label: 'Analitik' },
      { href: '/seller/withdrawals', icon: Wallet, label: 'Penarikan' },
  ...
  },
  {
    label: 'Lainnya',
    items: [
      { href: '/affiliator/dashboard', icon: Link2, label: 'Affiliator', badge: 'Plus', badgeColor: '#F59E0B' },
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <header className="h-16 bg-white border-b border-border sticky top-0 z-30 flex items-center px-4 sm:px-6 gap-4 shadow-sm">
        {/* Logo */}
        <Link href="/seller/dashboard" className="flex items-center gap-2 flex-shrink-0 mr-2">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[9px] text-primary font-semibold leading-none">Seller Panel</p>
          </div>
        </Link>
